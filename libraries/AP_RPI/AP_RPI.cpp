...
#define AP_SERIALMANAGER_R_PI_BAUD      115200
#define AP_SERIALMANAGER_R_PI_RX        64
#define AP_SERIALMANAGER_R_PI_TX        64
...
void AP_RPI::init(const AP_SerialManager& serial_manager)
{
    ...
    if ((_port = serial_manager.find_serial(AP_SerialManager::SerialProtocol_R_PI, 0))) {
        ...
        // initialise uart
        _port->begin(AP_SERIALMANAGER_R_PI_BAUD, AP_SERIALMANAGER_R_PI_RX, AP_SERIALMANAGER_R_PI_TX);
    }
}
